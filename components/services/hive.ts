    ...
    private processTick() {
        ...
        for (const strategy of activeStrategies) {
            try {
                ...
                console.error(`[HiveMind] Erro na estratégia:`, e);
            }
        }
        ...
        if (potentialSignals.length > 0) {
            ...
            console.log(`[HiveMind] Melhor oportunidade detectada: ${bestSignal.asset} (${bestSignal.strategyName}) - Score: ${bestSignal.finalScore.toFixed(2)}`);
