...
class MarketStateStore {
    ...
    update(asset: string, candles: MarketCandle[]) {
        ...
        console.log(`[MarketState] Atualizando ${asset} | Preço: ${currentPrice}`);
    ...
    notifyUpdates() {
        console.log(`[MarketState] Notificando ${this._listeners.size} ouvintes.`);
    ...
    getLastUpdateTimestamp() {
        ...
        this._cache.forEach(state => {
            if (state.lastUpdated > latest) latest = state.lastUpdated;
        });
        return latest;
    }
